...
public class TaskControllerTest {
    ...
    public void shouldFetchTaskList() throws Exception {
        //Given
        List<TaskDto> taskDtoList = new ArrayList<>();
        taskDtoList.add(new TaskDto(1L, "test_list", "test"));
        ...
        mockMvc.perform(get("/v1/task/getTasks").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].title", is("test_list")))
    ...
    public void shouldFetchTask() throws Exception {
        //Given
        TaskDto taskDto = new TaskDto(1L, "test_list", "test");
        Task task = new Task(1L, "test_list", "test");
        ...
        mockMvc.perform(get("/v1/task/getTask")
                ...
                .andExpect(jsonPath("$.title", is("test_list")))
