...
public class TrelloControllerTest {
    ...
    public void shouldFetchTrelloBoards() throws Exception {
        //Given
        List<TrelloListDto> trellLists = new ArrayList<>();
        trellLists.add(new TrelloListDto("test_id", "test_list", false));

        List<TrelloBoardDto> trelloBoards = new ArrayList<>();
        trelloBoards.add(new TrelloBoardDto("test_id", "test_board",trellLists));
        ...
        mockMvc.perform(get("/v1/trello/boards").contentType(MediaType.APPLICATION_JSON))
                ...
                .andExpect(jsonPath("$[0].name", is("test_board")))
                // Trello list fields
                .andExpect(jsonPath("$[0].lists", hasSize(1)))
                .andExpect(jsonPath("$[0].lists[0].id", is("test_id")))
